...
function getDetailsArray() {
    ...
    else if (activityStepValue == 'step6') { return { 'Awareness': { Real: 0, Tampered: 0, Deepfake: 0 }, 'Heatmap': { Real: 0, Tampered: 0, Deepfake: 0 }, 'Spatial': { Real: 0, Tampered: 0, Deepfake: 0 }, 'Colour': { Real: 0, Tampered: 0, Deepfake: 0 }, 'No Further Insights': { Real: 0, Tampered: 0, Deepfake: 0 }}; }
